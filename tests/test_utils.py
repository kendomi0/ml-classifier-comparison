...
@pytest.mark.parametrize("user_input", ["blobs", "noisy_moons", "noisy_circles", "anisotropic", "varied"])
def test_get_user_choice_valid(monkeypatch, user_input):
    test_dict = {"blobs": 1, "noisy_moons": 2, "noisy_circles": 3, "anisotropic": 4, "varied": 5}
...
def test_get_user_choice_invalid_then_valid(monkeypatch):
    test_dict = {"blobs": 1, "noisy_moons": 2}
